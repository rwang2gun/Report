...
**재검증 필요 나머지 8명** (2026-03 보고서):
- [ ] **바르카(원신)** — 설정·속성·파티 메커니즘
- [ ] **스파키(스타레일)** — 웃음 포인트 시스템 정확성
- [ ] **애쉬베일(스타레일)** — 미끼 추공·성별(He/him) 확인
- [ ] **시그리카(젠레스)** — 룬 3단 메커니즘·구원 의존도
- [ ] **구원(명조)** — 검객 설정·속성
- [ ] **남궁우(명조)** — 엔젤디 리더·리드 댄서·여캐 확인
- [ ] **탕탕(엔드필드)** — 무릉 청파채 대당가·물 속성·와류 용오름
- [ ] **아르카나(니케)** — SSR 이격·샷건·버닝 확인
